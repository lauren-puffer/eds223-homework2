...
# get bounding box of HOLC data as a polygon
holc_bbox <- st_as_sfc(st_bbox(redlining_reproj))

# clip EJSCREEN data to HOLC extent
ej_screen_clip <- st_crop(ej_screen_la, holc_bbox)
